   ...
   #    r = requests.get('http://localhost:8080/counter/areas')
    ...
    def hour_analysis(self, combo):
        ...
        while True: 
            ...
            self.person_count hour_time = self.analyse("chair", z)
           ...
           hour_truck_count[0:z] = truck_count[0:z] 
           hour_person_count[0:z] = person_count[0:z] 
           hour_bus_count[0:z] = bus_count[0:z] 
           hour_car_count[0:z] = car_count[0:z] 
           hour_bike_count[0:z] = bike_count[0:z]
           z = z+1 
